...
public class UserAssignmentApi {
     ...
     */
    public okhttp3.Call organizationsIdOrganizationAssignUserUserIdPostCall(Integer idOrganization, Integer userId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call organizationsIdOrganizationAssignUserUserIdPostValidateBeforeCall(Integer idOrganization, Integer userId, final ApiCallback _callback) throws ApiException {
     ...
     */
    public void organizationsIdOrganizationAssignUserUserIdPost(Integer idOrganization, Integer userId) throws ApiException {
     ...
     */
    public ApiResponse<Void> organizationsIdOrganizationAssignUserUserIdPostWithHttpInfo(Integer idOrganization, Integer userId) throws ApiException {
     ...
     */
    public okhttp3.Call organizationsIdOrganizationAssignUserUserIdPostAsync(Integer idOrganization, Integer userId, final ApiCallback<Void> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call organizationsIdOrganizationRemoveUserUserIdDeleteCall(Integer idOrganization, Integer userId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call organizationsIdOrganizationRemoveUserUserIdDeleteValidateBeforeCall(Integer idOrganization, Integer userId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'idOrganization' is set
        if (idOrganization == null) {
     ...
     */
    public void organizationsIdOrganizationRemoveUserUserIdDelete(Integer idOrganization, Integer userId) throws ApiException {
     ...
     */
    public ApiResponse<Void> organizationsIdOrganizationRemoveUserUserIdDeleteWithHttpInfo(Integer idOrganization, Integer userId) throws ApiException {
     ...
     */
    public okhttp3.Call organizationsIdOrganizationRemoveUserUserIdDeleteAsync(Integer idOrganization, Integer userId, final ApiCallback<Void> _callback) throws ApiException {
